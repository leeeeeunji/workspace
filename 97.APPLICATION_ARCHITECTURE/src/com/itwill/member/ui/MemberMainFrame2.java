...
public class MemberMainFrame2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MemberMainFrame2 frame = new MemberMainFrame2();
	 ...
	 * Create the frame.
	 */
	public MemberMainFrame2() throws Exception {
		setTitle("회원관리");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 533, 631);
		...
		memberMainLB.setIcon(new ImageIcon(MemberMainFrame2.class.getResource("/images/donut.gif")));
		...
		memberTabbedPane.addTab("New tab", null, categoriesPanel, null);
