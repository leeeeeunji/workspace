...
public class FileWriterReaderMain {
	...
	public static void main(String[] args) throws Exception {
		...
		fr.close();
		System.out.println();System.out.println(charCount + "문자 읽음");
		System.out.println();System.out.println(lineCount + "라인 읽음");
		System.out.println();System.out.println(munjaCount + "개(인)");
