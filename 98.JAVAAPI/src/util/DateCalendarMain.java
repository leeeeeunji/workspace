...
public class DateCalendarMain {
	...
	public static void main(String[] args) throws Exception {
		...
		Date myBirthDay = sdf2.parse("1995-04-25");
		...
		Date yourBirthDay = sdf2.parse("1995/05/12 17:45:13");
