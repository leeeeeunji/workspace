...
public class StringUseMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("오늘은 금요일 String클래스를 공부해요.".substring(4, 7));
		System.out.println("오늘은 금요일 String클래스를 공부해요.".substring(4));
		
		System.out.println("----------chatAt-----------");
		String userId = "testST#00?%&5";
		char firstChar = userId.charAt(0);
		System.out.println(">>아이디의 첫 글자는 영문대(소)문자여야 한다.");
		...
		String cardNo = "123-456-7890-4562";
