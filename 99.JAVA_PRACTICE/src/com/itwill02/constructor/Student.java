...
public class Student {
	...
	public Student(int no, String name, int kor, int eng, int math) {
		this.no = no; // = this.setStudentData(no, name, kor, eng, math);
		this.name = name;
		this.kor = kor;
		this.eng = eng;
		this.math = math;
	...
	// 멤버메쏘드 선언
	/*
	 * 기본데이타(번호,이름,국어,영어,수학) 멤버변수에 대입하는 메쏘드
	 */
	 ...
	 */
	public void print() {
		System.out.printf("%2d %4s %3d %3d %4d %4d %6.1f %3c %3d%n", this.no, this.name, this.kor, this.eng, this.math, this.tot, this.avg, this.grade, this.rank);
	}
